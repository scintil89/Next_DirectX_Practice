...
#define szWindowClass	TEXT("04 RenderState")
#define szTitle			TEXT("04 RenderState")
...
ID3D11RasterizerState *		g_ptestRS;
...
void CreateRenderState3()
{
	...
	rasterizerDesc.FrontCounterClockwise = false;	  // 앞/뒷면 로직 선택 CCW
	// 반시계 방향을 앞면으로 할 것인가?
	g_pd3dDevice->CreateRasterizerState(&rasterizerDesc, &g_ptestRS);
}
